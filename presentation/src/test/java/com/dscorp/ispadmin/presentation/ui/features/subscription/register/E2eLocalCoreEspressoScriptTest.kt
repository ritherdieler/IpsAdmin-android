...
class E2eLocalCoreEspressoScriptTest {
    ...
    fun `local core espresso script talks to Core via emulator reverse not staging or prod`() {
        ...
        assertThat(text).contains("E2E_WIFI_SSID=\"\${E2E_WIFI_SSID:-\$_E2E_WIFI_SSID_DEFAULT}\"")
        ...
        assertThat(prod).contains("E2E_WIFI_SSID=\"\${E2E_WIFI_SSID:-\$_E2E_WIFI_SSID_DEFAULT}\"")

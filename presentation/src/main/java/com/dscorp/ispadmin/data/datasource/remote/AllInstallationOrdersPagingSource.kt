...
/**
 * PagingSource para cargar todas las órdenes de instalación sin filtros.
 */
class AllInstallationOrdersPagingSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, InstallationOrder> {
        ...
        return try {
            val response = api.getAllInstallationOrdersPaginated(
                page = page,
                size = PAGE_SIZE
            )

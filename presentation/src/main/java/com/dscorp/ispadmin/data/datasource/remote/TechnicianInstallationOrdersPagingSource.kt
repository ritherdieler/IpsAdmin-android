...
/**
 * PagingSource para cargar órdenes de instalación por technicianId.
 */
class TechnicianInstallationOrdersPagingSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, InstallationOrder> {
        ...
        return try {
            val response = api.getInstallationOrdersByTechnicianPaginated(
